...
`;
  var APP_ADS_TXT = `google.com, pub-2030137443667873, DIRECT, f08c47fec0942fa0
unity.com, 7551469, DIRECT, 96cabb5fbdde37a7
...
`;
  ...
  async function handleRequest(request) {
    ...
    if (path === "/ads.txt") return textResponse(ADS_TXT);
